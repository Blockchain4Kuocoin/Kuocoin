...
export default function Signup() {
    ...
    const onSubmit = () => {
        ...
        if (info.pw !== info.confirmPassword) alert("비밀번호가 일치하지 않습니다")
    ...
    return (
        <div className="loginregister">
            <form>
                ...
                <input name="pw" type="password" placeholder="비밀번호" value={ info.pw || "" }  className="loginregister__input" onChange={ onChange } onKeyDown={onKeyDown}/><br/>
                <input name="confirmPassword" type="password" placeholder="비밀번호 확인" value={ info.confirmPassword || "" } className="loginregister__input" onChange={ onChange } onKeyDown={onKeyDown}/><br/>
